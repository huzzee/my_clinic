                                    ...
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Patient Name :</strong> <span class="m-l-15">
                                                    <?php echo e($prescriptions->patients->patient_info['full_name']); ?></span></p>

                                            <p class="text-muted font-13"><strong>Patient Code :</strong><span class="m-l-15">
                                                <?php echo e($prescriptions->patients->patient_code); ?></span></p>

                                            <p class="text-muted font-13"><strong>Age :</strong> <span class="m-l-15">
                                                    <?php $age = date('Y', strtotime(Carbon\Carbon::now())) - date('Y', strtotime($prescriptions->patients->patient_info['date_of_birth'])); ?>
                                                    <?php echo e($age); ?></span></p>

                                            <p class="text-muted font-13"><strong>Gender :</strong>
                                                <span class="m-l-15">
                                                    <?php if($prescriptions->patients->patient_info['gender'] == 0): ?>
                                                        Male
                                                    <?php elseif($prescriptions->patients->patient_info['gender'] == 1): ?>
                                                        Female
                                                    <?php elseif($prescriptions->patients->patient_info['gender'] == 2): ?>
                                                        Other
                                            ...
                                            <p class="text-muted font-13"><strong>Doctor Name :</strong> <span class="m-l-15">
                                                    <?php echo e($prescriptions->user_informations->users['name']); ?></span></p>

                                            <p class="text-muted font-13"><strong>Department :</strong><span class="m-l-15">
                                                <?php echo e($prescriptions->user_informations->doctor_info['department']); ?></span></p>
                                ...
                                <div class="text-center card-box" style="min-height: 270px">
                                    <div class="member-card">
                                        ...
                                        <table class="table table-striped m-0">
                                            ...
                                            <tbody>
                                            <?php $k=1; ?>
                                                <?php $__currentLoopData = $prescriptions->prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($k); ?></td>
                                                        <td><?php echo e($prescription['drug_name']); ?>

                                                            <?php if($prescription['dosage_qnt'] !== '0'): ?>
                                                            -<?php echo e($prescription['dosage_qnt']); ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2" id="drug_pres">
                                                                            ...
                                                                            <?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($medicine->id); ?>"><?php echo e($medicine->medicine_info['drug_name']); ?> -(<?php echo e($medicine->medicine_info['dosage_amount']); ?>.<?php echo e($medicine->medicine_info['dosage_unit']); ?>)</option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
