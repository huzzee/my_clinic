            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <a class="btn btn-danger" href="<?php echo e(url('employee/create')); ?>">Create Employee</a>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($i); ?></td>
                                    <td><img src="<?php echo e(asset('uploads/'.$employee->users->profile_image)); ?>" alt="<?php echo e($employee->users->profile_image); ?>" style="height: 50px; width: 50px;"></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(url('employee/'.$employee->id)); ?>" class="btn btn-icon waves-effect waves-light btn-teal m-b-5" style="">
                                            <i class="fa fa-eye"></i>
                                        </a>
