            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Drugs Stock Unit</h4>
                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 col-md-12">
                                ...
                                <h4 class="header-title m-t-0">Create Stock Unit</h4>


                                <div class="p-20">
                                    <form action="<?php echo e(url('drugStock')); ?>" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <label for="unit_name" class="col-sm-3">Stock Unit Name<span class="text-danger">*</span></label>
                                            <div class="col-sm-7">
                                                <input type="text" name="unit_name" parsley-trigger="change" required
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $drugTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="font-size: 16px;"><?php echo e($type->unit_name); ?></td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="<?php echo e(url('drugStock/'.$type->id)); ?>" method="post">
                                                    <?php echo e(csrf_field()); ?>
