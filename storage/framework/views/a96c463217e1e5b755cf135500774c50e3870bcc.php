<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <?php echo Form::model($appointment, ['method' => 'PATCH','url' => ['appointments', $appointment->id], 'files'=>true]); ?>
                                ...
                                <div class="col-sm-12 col-xs-12 col-md-12">
                                    ...
                                    <div class="p-20" style="clear: both;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control"
                                                       value="<?php echo e($appointment->patients->patient_info['full_name']); ?>" readonly>
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control"
                                                       value="<?php echo e($appointment->patients->patient_code); ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <?php echo Form::select('doctor_id',$doctors,null ,['class' => 'form-control select2','id' => 'app_doc_id']); ?>
                                        ...
                                        <div class="row" id="app_date_here" style="display: none">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="input-group">
                                                    <?php echo form::text('appointment_date',date('m/d/Y',strtotime($appointment->appointment_date)),['class' => 'form-control','placeholder' => 'mm/dd/yyyy',
                                                    'id' => 'datepicker2']); ?>
