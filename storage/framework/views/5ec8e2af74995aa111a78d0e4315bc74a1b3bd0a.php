<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <form action="<?php echo e(route('medical_records.store')); ?>" id="record_submit"  enctype="multipart/form-data" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            <a class="btn btn-info" href="<?php echo e(url('medical_records')); ?>">Manage Medical Records</a>
                            <hr>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm"
                                               value="<?php echo e($patients->patient_info['full_name']); ?>" readonly="" required>
                                        <input type="hidden" value="<?php echo e($patients->id); ?>" name="patient_id">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm"
                                               value="<?php echo e($patients['patient_code']); ?>" readonly required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-sm"
                                               value="<?php echo e($doctors->users['name']); ?>" readonly="" required>
                                        <input type="hidden" value="<?php echo e($doctors->id); ?>" name="doctor_id">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="diagnose" id="textarea" class="form-control" maxlength="500" rows="3" placeholder="Diagnoses" value="<?php echo e(old('diagnose')); ?>"></textarea>
                                    </div>
                                </div>
                            </div>
