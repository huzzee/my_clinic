                                    ...
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">
                                                    <?php echo e($invoice->patients->patient_info['full_name']); ?></span></p>

                                            <p class="text-muted font-13"><strong>Patient Code :</strong><span class="m-l-15">
                                                <?php echo e($invoice->patients->patient_code); ?></span></p>
                                            ...
                                            <p class="text-muted font-13"><strong>Drug Allergy :</strong><span class="m-l-15">
                                                <?php $__currentLoopData = $invoice->patients->drug_allergy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-6 col-md-6" >
                                <div class="text-center card-box" style="min-height: 270px">
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">
                                                    <?php echo e($invoice->user_informations->users['name']); ?></span></p>

                                            <p class="text-muted font-13"><strong>Department :</strong><span class="m-l-15">
                                                <?php echo e($invoice->user_informations->doctor_info['department']); ?></span></p>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <?php echo Form::model($invoice, ['method' => 'PATCH','url' => ['invoices', $invoice->id], 'files'=>true]); ?>


                                            <?php echo e(csrf_field()); ?>

                                            <input type="hidden" name="patient_id" value="<?php echo e($invoice->patients->id); ?>">
                                            <input type="hidden" name="doctor_id" value="<?php echo e($invoice->user_informations->id); ?>">
                                            <input type="hidden" name="queue_id" value="<?php echo e($invoice->queue_id); ?>">
                                            <div class="row" style="min-height: 300px;">
                                                ...
                                                <table class="table table-striped m-0">
                                                    ...
                                                    <?php $__currentLoopData = $invoice->prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pres): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr>
                                                            <td><?php echo e($pres['drug_name']); ?><input type="hidden" name="drug_name[]" value="<?php echo e($pres['drug_name']); ?>">
                                                                <input type="hidden" name="drug_id[]" value="<?php echo e($pres['drug_id']); ?>"></td>
                                                            <td><?php echo e($pres['drug_qnt']); ?><input type="hidden" class="medicine_qnt" name="drug_qnt[]" value="<?php echo e($pres['drug_qnt']); ?>"></td>
                                                            <td><?php echo e($pres['price']); ?><input type="hidden" class="price" name="price[]" value="<?php echo e($pres['price']); ?>"></td>
                                                            <td><?php echo e($pres['sub_total']); ?><input type="hidden" class="sub_total" name="sub_total[]" value="<?php echo e($pres['sub_total']); ?>"></td>
                                                            <td><?php echo e($pres['discount']); ?>%<input type="hidden" class="discount" name="discount[]" value="<?php echo e($pres['discount']); ?>"></td>
                                                            <td><?php echo e($pres['remark']); ?><input type="hidden" name="remark[]" value="<?php echo e($pres['remark']); ?>"></td>
                                                            <td><?php echo e($pres['gst']); ?>%<input type="hidden" class="gst" name="gst[]" value="<?php echo e($pres['gst']); ?>"></td>
                                                            <td><?php echo e($pres['line_total']); ?><input type="hidden" class="line_total" name="line_total[]" value="<?php echo e($pres['line_total']); ?>">
                                                                <input type="hidden" name="pres_type[]" value="<?php echo e($pres['pres_type']); ?>"></td>
                                                            <input type="hidden" name="days[]" value="<?php echo e($pres['days']); ?>"></td>
                                                            <input type="hidden" name="instruction[]" value="<?php echo e($pres['instruction']); ?>"></td>
                                                            <input type="hidden" name="dosage_qnt[]" value="<?php echo e($pres['dosage_qnt']); ?>">
                                                            <input type="hidden" name="dosage_unit[]" value="<?php echo e($pres['dosage_unit']); ?>"></td>
                                                            <td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5 m-t-40">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo form::textarea('invoice_comment',null,['class' => 'Invoice form-control',
                                                        'maxlength' => '500','rows' => '5','placeholder' => 'Invoice Comment']); ?>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="<?php echo e($invoice->net_total); ?>" readonly id="net_total" name="net_total">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="<?php echo e($invoice->total_discount); ?>" readonly id="total_discount" name="total_discount">
                                                            <span class="input-group-addon"><?php echo e(Auth::user()->entities->currency); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="<?php echo e($invoice->after_discount); ?>" readonly id="after_discount" name="after_discount">
                                                            <span class="input-group-addon"><?php echo e(Auth::user()->entities->currency); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="<?php echo e($invoice->total_gst); ?>" readonly id="total_gst" name="total_gst">
                                                            <span class="input-group-addon"><?php echo e(Auth::user()->entities->currency); ?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="<?php echo e($invoice->grand_total); ?>" readonly id="grand_total" name="grand_total">
                                                            <span class="input-group-addon"><?php echo e(Auth::user()->entities->currency); ?></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <button type="submit" name="payment" value="0" class="btn btn-inverse waves-effect waves-light m-b-5">Update Invoice</button>
