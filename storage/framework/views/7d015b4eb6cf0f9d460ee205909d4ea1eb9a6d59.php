<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <?php echo Form::model($drug, ['method' => 'PATCH','url' => ['drugs', $drug->id], 'files'=>true]); ?>
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12 col-md-12">
                                    ...
                                    <a class="btn btn-info" href="<?php echo e(url('drugs')); ?>">Drugs List</a>
                                    ...
                                    <div class="p-20" style="clear: both;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::text('medicine_info[drug_name]' , null ,['class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::select('medicine_info[drug_type]',$drugType,null ,['class' => 'form-control select2']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <?php echo Form::select('medicine_info[dosage_unit]',['Amp' => 'Amp','Mg' => 'Mg',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::number('medicine_info[dosage_amount]' , null ,['class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group">
                                                    <?php echo Form::number('medicine_info[purchase_price]' , null ,['placeholder' => 'Enter Purchase Price','class' => 'form-control','parsley-trigger' => 'change']); ?>
                                            ...
                                            <div class="col-sm-4">
                                                <?php echo Form::number('medicine_info[purchase_gst]' , null ,['placeholder' => 'Enter Gst %','class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="input-group">
                                                    <?php echo Form::number('medicine_info[retail_price]' , null ,['placeholder' => 'Enter Retail Price','class' => 'form-control','parsley-trigger' => 'change']); ?>
                                            ...
                                            <label for="retail_price" class="col-sm-1">GST in %</label>
                                            <div class="col-sm-4">
                                                <?php echo Form::number('medicine_info[retail_gst]' , null ,['placeholder' => 'Enter Gst %',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::text('medicine_info[generic]' , null ,['placeholder' => 'Enter Generic Name',
                                               'class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::text('medicine_info[company]' , null ,['placeholder' => 'Enter Company Name',
                                              'class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::select('medicine_info[stock_unit]',$drugStock,null ,['class' => 'form-control select2']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::number('medicine_info[min_qnt]' , null ,['placeholder' => 'Enter Warning Quantity',
                                                'class' => 'form-control','parsley-trigger' => 'change']); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php echo Form::textarea('medicine_info[precaution]' , null ,['placeholder' => 'Precaution Here If Important',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="filestyle" placeholder="<?php echo e($drug->medicine_info['drug_image']); ?>" name="drug_image" data-buttonname="btn-danger">
                                            </div>
                                        </div>
