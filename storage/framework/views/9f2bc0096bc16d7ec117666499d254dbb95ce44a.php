                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 col-md-12">
                                ...
                                <h4 class="header-title m-t-0">Create Clinic Services</h4>
                                ...
                                <div class="p-20">
                                    <form action="<?php echo e(route('services.store')); ?>" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <label for="item_type" class="col-sm-2">Service Name<span class="text-danger">*</span></label>
                                            <div class="col-sm-4">
                                                <input type="text" name="service_name" parsley-trigger="change" required
                                                       placeholder="Enter Service Name" class="form-control" id="service_name"/>
                                            </div>

                                            <div class="col-sm-4">
                                                <input type="number" name="rate" parsley-trigger="change" required
                                                       placeholder="Enter Service Rate" class="form-control" id="rate"/>
                                            </div>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="font-size: 16px;"><?php echo e($service->service_name); ?></td>
                                    <td style="font-size: 16px;"><?php echo e($service->rate); ?></td>
                                    <td>
                                        <button class="btn btn-icon waves-effect waves-light btn-danger m-b-5" data-toggle="modal" data-target="#con-close-modal<?php echo e($service->id); ?>"><i class="fa fa-remove"></i></button>
                                    </td>

                                </tr>

                                <div id="con-close-modal<?php echo e($service->id); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="<?php echo e(url('services/'.$service->id)); ?>" method="post">
                                                    <?php echo e(csrf_field()); ?>
