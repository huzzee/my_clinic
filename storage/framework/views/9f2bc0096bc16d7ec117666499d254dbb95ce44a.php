                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="rate" placeholder="Enter Service Cost in <?php echo e(Auth::user()->entities->currency); ?>">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td style="font-size: 16px;"><?php echo e($service->service_categories->category_name); ?></td>
                                    <td style="font-size: 16px;"><?php echo e($service->service_name); ?></td>
                                    <td style="font-size: 16px;"><?php echo e($service->rate); ?>.<?php echo e(Auth::user()->entities->currency); ?></td>
                                    <td>
