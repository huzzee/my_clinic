                    ...
                    <div id="full-width-modal-create" class="modal fade" role="dialog" aria-labelledby="full-width-modalLabel-create" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-full">
                            <div class="modal-content">
                                ...
                                <form id="patient_add_submit" action="<?php echo e(route('patients.store')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <button id="results" type="button" class="dropdown-toggle"
                                                            ...
                                                            style="background-image: url('<?php echo e(asset('src/img/image_upload.png')); ?>');
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="address" parsley-trigger="change"
                                                                   placeholder="Enter Address" value="<?php echo e(old('address')); ?>" autocomplete="off" class="form-control input-sm"/>
                                ...
                                <div class="member-card" style="max-height: 350px;min-height: 350px; overflow: auto;">
                                    <table class="table table-responsive">
                                        ...
                                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td width="5%" style="font-size: 11px;"><?php echo e($ai); ?>#</td>
                                                <td align="left">
                                                    <a href="javascript:void(0);" class="patient_all_info" data-patient_id="<?php echo e($patient->id); ?>"
                                                    style="font-weight: bold;color: #1f648b; font-size: 11px;">
                                                        <?php echo e($patient->patient_info['full_name']); ?>

                                                        (<?php echo e($patient->patient_code); ?>)</a></td>
                                            </tr>
                            ...
                            <div class="text-center card-box">
                                <div class="member-card">
                                    <table class="table table-responsive">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($today == date('d-m-Y', strtotime($patient->created_at))): ?>
                                            <tr>
                                                <td width="5%" style="font-size: 11px;"><?php echo e($ti); ?>#</td>
                                                <td align="left">
                                                    <a href="javascript:void(0);" class="patient_all_info" data-patient_id="<?php echo e($patient->id); ?>"
                                                       style="font-weight: bold;color: #1f648b; font-size: 11px;">
                                                        <?php echo e($patient->patient_info['full_name']); ?>
                                ...
                                <div class="member-card">
                                    <table class="table table-responsive">
                                        ...
                                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($this_month == date('m-Y',strtotime($patient->created_at))): ?>
                                            <tr>
                                                <td width="5%" style="font-size: 11px;"><?php echo e($ai); ?>#</td>
                                                <td align="left">
                                                    <a href="javascript:void(0);" class="patient_all_info" data-patient_id="<?php echo e($patient->id); ?>"
