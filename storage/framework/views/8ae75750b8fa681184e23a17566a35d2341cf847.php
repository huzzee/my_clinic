<?php $__env->startSection('content'); ?>
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <form action="<?php echo e(route('drugs.store')); ?>" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="col-sm-12 col-xs-12 col-md-12">
                                    ...
                                    <div class="p-20" style="clear: both;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="drug_name" parsley-trigger="change"
                                                       placeholder="Enter Drug Name" class="form-control" value="<?php echo e(old('drug_name')); ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="generic" parsley-trigger="change"
                                                       placeholder="Enter Generic Name" class="form-control" value="<?php echo e(old('dosage_unit')); ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="company" parsley-trigger="change"
                                                       placeholder="Enter Company Name" class="form-control" value="<?php echo e(old('dosage_unit')); ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control select2" name="stock_unit">
                                                    ...
                                                    <?php $__currentLoopData = $drugUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($type->unit_name); ?>"><?php echo e($type->unit_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="precaution" id="textarea" class="form-control" maxlength="225" rows="5" placeholder="Precaution Here If Important" value="<?php echo e(old('precaution')); ?>"></textarea>
                                            </div>
                                        </div>
