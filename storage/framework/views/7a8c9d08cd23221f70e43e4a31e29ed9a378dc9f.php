                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            data-toggle="modal" data-target="#con-close-modal<?php echo e($patient->patient_code); ?>">#Add to queue</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('queues.store')); ?>" method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="hidden" name="patient_id" value="<?php echo e($appointment->patients->id); ?>">
