                                                            ...
                                                            <?php $__currentLoopData = $schedule->schedule_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($detail->type == 0): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo e($detail->days); ?><input type="hidden" name="opd_day[]" value="<?php echo e($detail->days); ?>"></td>
                                                                        <td><?php echo e($detail->start_time); ?><input type="hidden" name="opd_start_time[]" value="<?php echo e($detail->start_time); ?>"></td>
                                                                        <td><?php echo e($detail->end_time); ?><input type="hidden" name="opd_end_time[]" value="<?php echo e($detail->end_time); ?>"></td>
                                                                        <td>
                                                        ...
                                                        <?php $__currentLoopData = $schedule->schedule_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($detail->type == 1): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e($detail->days); ?><input type="hidden" name="app_day[]" value="<?php echo e($detail->days); ?>"></td>
                                                                    <td><?php echo e($detail->start_time); ?><input type="hidden" name="app_start_time[]" value="<?php echo e($detail->start_time); ?>"></td>
                                                                    <td><?php echo e($detail->end_time); ?><input type="hidden" name="app_end_time[]" value="<?php echo e($detail->end_time); ?>"></td>
                                                                    <td>
