                                    ...
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">
                                                    {{ $invoice->patients->patient_info['full_name'] }}</span></p>

                                            <p class="text-muted font-13"><strong>Patient Code :</strong><span class="m-l-15">
                                                {{ $invoice->patients->patient_code }}</span></p>
                                            ...
                                            <p class="text-muted font-13"><strong>Drug Allergy :</strong><span class="m-l-15">
                                                @foreach($invoice->patients->drug_allergy as $allergy)
                                                        {{ $allergy['drug_name'] }},
                                                    @endforeach</span></p>
                            ...
                            <div class="col-lg-6 col-md-6" >
                                <div class="text-center card-box" style="min-height: 270px">
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">
                                                    {{ $invoice->user_informations->users['name'] }}</span></p>

                                            <p class="text-muted font-13"><strong>Department :</strong><span class="m-l-15">
                                                {{ $invoice->user_informations->doctor_info['department'] }}</span></p>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        {!! Form::model($invoice, ['method' => 'PATCH','url' => ['invoices', $invoice->id], 'files'=>true]) !!}

                                            {{ csrf_field() }}
                                            <input type="hidden" name="patient_id" value="{{ $invoice->patients->id }}">
                                            <input type="hidden" name="doctor_id" value="{{ $invoice->user_informations->id }}">
                                            <input type="hidden" name="queue_id" value="{{ $invoice->queue_id }}">
                                            <div class="row" style="min-height: 300px;">
                                                ...
                                                <table class="table table-striped m-0">
                                                    ...
                                                    @foreach($invoice->prescriptions as $pres)
                                                        ...
                                                        <tr>
                                                            <td>{{ $pres['drug_name'] }}<input type="hidden" name="drug_name[]" value="{{ $pres['drug_name'] }}">
                                                                <input type="hidden" name="drug_id[]" value="{{ $pres['drug_id'] }}"></td>
                                                            <td>{{ $pres['drug_qnt'] }}<input type="hidden" class="medicine_qnt" name="drug_qnt[]" value="{{ $pres['drug_qnt'] }}"></td>
                                                            <td>{{ $pres['price'] }}<input type="hidden" class="price" name="price[]" value="{{ $pres['price'] }}"></td>
                                                            <td>{{ $pres['sub_total'] }}<input type="hidden" class="sub_total" name="sub_total[]" value="{{ $pres['sub_total'] }}"></td>
                                                            <td>{{ $pres['discount'] }}%<input type="hidden" class="discount" name="discount[]" value="{{ $pres['discount'] }}"></td>
                                                            <td>{{ $pres['remark'] }}<input type="hidden" name="remark[]" value="{{ $pres['remark'] }}"></td>
                                                            <td>{{ $pres['gst'] }}%<input type="hidden" class="gst" name="gst[]" value="{{ $pres['gst'] }}"></td>
                                                            <td>{{ $pres['line_total'] }}<input type="hidden" class="line_total" name="line_total[]" value="{{ $pres['line_total'] }}">
                                                                <input type="hidden" name="pres_type[]" value="{{ $pres['pres_type'] }}"></td>
                                                            <input type="hidden" name="days[]" value="{{ $pres['days'] }}"></td>
                                                            <input type="hidden" name="instruction[]" value="{{ $pres['instruction'] }}"></td>
                                                            <input type="hidden" name="dosage_qnt[]" value="{{ $pres['dosage_qnt'] }}">
                                                            <input type="hidden" name="dosage_unit[]" value="{{ $pres['dosage_unit'] }}"></td>
                                                            <td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5 m-t-40">
                                                    <div class="form-group">
                                                        ...
                                                        {!! form::textarea('invoice_comment',null,['class' => 'Invoice form-control',
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="{{ $invoice->net_total }}" readonly id="net_total" name="net_total">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="{{ $invoice->total_discount }}" readonly id="total_discount" name="total_discount">
                                                            <span class="input-group-addon">{{ Auth::user()->entities->currency }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="{{ $invoice->after_discount }}" readonly id="after_discount" name="after_discount">
                                                            <span class="input-group-addon">{{ Auth::user()->entities->currency }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="{{ $invoice->total_gst }}" readonly id="total_gst" name="total_gst">
                                                            <span class="input-group-addon">{{ Auth::user()->entities->currency }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-8">
                                                            <input type="text" class="form-control" value="{{ $invoice->grand_total }}" readonly id="grand_total" name="grand_total">
                                                            <span class="input-group-addon">{{ Auth::user()->entities->currency }}</span>
                                                        </div>
                                                    </div>
