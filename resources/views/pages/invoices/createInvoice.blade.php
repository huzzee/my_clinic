                                    ...
                                    <div class="member-card">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">
                                                    {{ $patients->patient_info['full_name'] }}</span></p>

                                            <p class="text-muted font-13"><strong>Patient Code :</strong><span class="m-l-15">
                                                {{ $patients->patient_code }}</span></p>

                                            <p class="text-muted font-13"><strong>Age :</strong> <span class="m-l-15">
                                                    @php $age = date('Y', strtotime(Carbon\Carbon::now())) - date('Y', strtotime($patients->patient_info['date_of_birth'])); @endphp
                                                    {{ $age }}</span></p>

                                            <p class="text-muted font-13"><strong>Gender :</strong>
                                                <span class="m-l-15">
                                                    @if($patients->patient_info['gender'] == 0)
                                                        Male
                                                    @elseif($patients->patient_info['gender'] == 1)
                                                        Female
                                                    @elseif($patients->patient_info['gender'] == 2)
                                                        Other
