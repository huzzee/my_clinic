            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select class="select_pres_record2 select2"
                                                                    data-style="btn btn-teal" data-prescription_id="{{$prescription->id}}">
                                                                <option value="0">Vital Signs</option>
                                                                <option value="1">Medical Notes</option>
                                                                <option value="2">Medical Templates</option>
                                                                <option value="3">Drawing Pad</option>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-11">
                                                                        @for($j=0; $j < sizeof($prescription->medicalRecords->upload_file); $j++)
                                                                            <h5 align="left"><a href="{{ asset('uploads/'.$prescription->medicalRecords->upload_file[$j]) }}" target="_blank">Image {{ $j+1 }}</a></h5>
                                                                        @endfor
                                                                    </div>
                        ...
                        <div class="col-sm-12" align="center">{{ $prescriptions->links() }}</div>
                </div>
            </div>
