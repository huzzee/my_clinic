            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        {!! Form::model($doctor, ['method' => 'PATCH','url' => ['doctors', $doctor->id], 'files'=>true, 'id' => 'basic-form']) !!}
                            ...
                            <div>
                                ...
                                <section>
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            {!! Form::text('doctor_info[first_name]' , null ,['class' => 'form-control','parsley-trigger' => 'change']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label for="last_name" class="col-lg-2 control-label">Last Name<span class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            {!! Form::text('doctor_info[last_name]' , null ,['class' => 'form-control','parsley-trigger' => 'change']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!!Form::textarea('doctor_info[address]',null ,['class' => 'form-control','maxlength' => '225','rows' => '5', 'id' => 'textarea'])!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            {!! Form::text('doctor_info[date_of_birth]' , null ,['class' => 'form-control','id' => 'datepicker-autoclose','placeholder' => 'mm/dd/yyyy']) !!}
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!! Form::number('doctor_info[contact_no]' , null ,['class' => 'form-control','parsley-trigger' => 'change']) !!}
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="radio radio-info radio-inline">
                                                {!! Form::radio('doctor_info[gender]', 0,['id' => 'inlineRadio1']) !!}
                                                <label for="inlineRadio1"> Male </label>
                                            </div>
                                            <div class="radio radio-pink radio-inline">
                                                {!! Form::radio('doctor_info[gender]', 1,['id' => 'inlineRadio1']) !!}
                                                <label for="inlineRadio2"> Female </label>
                                            </div>

                                            <div class="radio radio-purple radio-inline">
                                                {!! Form::radio('doctor_info[gender]', 2,['id' => 'inlineRadio1']) !!}
                                ...
                                <section>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!! Form::text('doctor_info[department]' , null ,['class' => 'form-control','parsley-trigger' => 'change']) !!}
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!! Form::textarea('doctor_info[short_biography]' , null ,['class' => 'form-control','maxlength' => '225','rows' => '6', 'id' => 'textarea']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!!Form::select('doctor_info[blood_group]',['A+'=>'A+', 'A-'=>'A-', 'B+'=>'B+', 'B-'=>'B-',
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!! Form::text('doctor_info[specialist]' , null ,['class' => 'form-control','parsley-trigger' => 'change']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-lg-10">
                                            {!! Form::textarea('doctor_info[qualification]' , null ,['class' => 'form-control','maxlength' => '225','rows' => '6', 'id' => 'textarea']) !!}
                                        </div>
                                    </div>
